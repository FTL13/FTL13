...
DECLARE_LEVEL(EMPTY_AREA_1,CROSSLINKED,list(REACHABLE)),\
...
DECLARE_LEVEL(EMPTY_AREA_4,CROSSLINKED,list(REACHABLE)),\
DECLARE_LEVEL(EMPTY_AREA_5,CROSSLINKED,list(REACHABLE)),\
DECLARE_LEVEL(EMPTY_AREA_6,CROSSLINKED,list(REACHABLE)),\
DECLARE_LEVEL(EMPTY_AREA_7,CROSSLINKED,list(REACHABLE)),\
DECLARE_LEVEL(EMPTY_AREA_8,CROSSLINKED,list(REACHABLE)))
