...
/datum/species
	...
	var/list/scream_sounds = list() //List of sounds species makes when screaming
	var/list/female_scream_sounds = list() //List of sounds species females make when screaming (if apllicable)
