...
/proc/get_all_accesses()
	return list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_COURT,
	            ...
	            ACCESS_HEADS_VAULT, ACCESS_MINING_STATION, ACCESS_XENOBIOLOGY, ACCESS_CE, ACCESS_XO, ACCESS_HOS, ACCESS_RC_ANNOUNCE,
	            ACCESS_KEYCARD_AUTH, ACCESS_TCOMSAT, ACCESS_GATEWAY, ACCESS_MINERAL_STOREROOM, ACCESS_MINISAT, ACCESS_NETWORK, ACCESS_CLONING,
				ACCESS_HELM, ACCESS_HELMS_CONSOLE, ACCESS_MOFFICE, ACCESS_MUNITIONS, ACCESS_MINING, ACCESS_MAA)
...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(6) //supply
			return list(ACCESS_MAILSORTING, ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_MINERAL_STOREROOM, ACCESS_CARGO, ACCESS_QM, ACCESS_MOFFICE)
		if(7) //command
			return list(ACCESS_HEADS, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_CHANGE_IDS, ACCESS_AI_UPLOAD,
						ACCESS_TELEPORTER, ACCESS_EVA, ACCESS_GATEWAY, ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_HEADS_VAULT,
						ACCESS_XO, ACCESS_CAPTAIN, ACCESS_HELM, ACCESS_HELMS_CONSOLE, ACCESS_WEAPONS_CONSOLE)
...
/proc/get_all_jobs()
	return list("Assistant", "Captain", "Executive Officer", "Bartender", "Cook", "Botanist", "Quartermaster", "Cargo Technician",
				...
				"Research Director", "Scientist", "Roboticist", "Head of Security", "Master-at-Arms", "Detective", "Security Officer", "Bridge Officer")
