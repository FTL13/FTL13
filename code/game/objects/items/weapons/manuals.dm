...
<<<<<<< HEAD:code/game/objects/items/weapons/manuals.dm
//big pile of shit below.
=======
>>>>>>> 0fdd15d... Merge pull request #32108 from Mark9013100/10/25/2017_cloning_book_fix:code/game/objects/items/manuals.dm
	dat = {"<html>
				<head>
				<style>
				h1 {font-size: 18px; margin: 15px 0px 5px;}
...
/obj/item/weapon/book/manual/wiki/proc/initialize_wikibook()
	if(config.wikiurl)
		dat = {"
			...
			<iframe width='100%' height='97%' onload="pageloaded(this)" src="[config.wikiurl][page_link]" frameborder="0" id="main_frame"></iframe>
			</body>
			</html>
			"}
