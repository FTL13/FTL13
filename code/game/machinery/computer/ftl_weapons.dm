...
/obj/machinery/computer/ftl_weapons/New()
	..()
	if(secondary)
		desc = "This is a secondary Tactical computer, and older style model used only to supplement the main consoles when they become damaged. It will only work during General Quarters."
