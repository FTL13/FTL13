...
/datum/game_mode/proc/greet_revolutionary(datum/mind/rev_mind, you_are=1)
	...
	if (you_are)
		rev_mind.to_chat(current, "<span class='userdanger'>You are a member of the revolutionaries' leadership!</span>")
	for(var/datum/objective/objective in rev_mind.objectives)
		rev_mind.to_chat(current, "<B>Objective #[obj_count]</B>: [objective.explanation_text]")
...
/datum/game_mode/proc/add_revolutionary(datum/mind/rev_mind)
	...
	rev_mind.to_chat(current, "<span class='danger'><FONT size = 3> You are now a revolutionary! Help your cause. Do not harm your fellow freedom fighters. You can identify your comrades by the red \"R\" icons, and your leaders by the blue \"R\" icons. Help them kill the heads to win the revolution!</FONT></span>")
...
/datum/game_mode/proc/remove_revolutionary(datum/mind/rev_mind , beingborged)
	...
	if((rev_mind in revolutionaries) || remove_head)
		...
		if(beingborged)
			rev_mind.to_chat(current, "<span class='danger'><FONT size = 3>The frame's firmware detects and deletes your neural reprogramming! You remember nothing[remove_head ? "." : " but the name of the one who flashed you."]</FONT></span>")
			...
			rev_mind.to_chat(current, "<span class='danger'><FONT size = 3>You have been brainwashed! You are no longer a revolutionary! Your memory is hazy from the time you were a rebel...the only thing you remember is the name of the one who brainwashed you...</FONT></span>")
