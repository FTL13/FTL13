...
GLOBAL_LIST_INIT(sap_names, world.file2list("strings/names/sap.txt"))
GLOBAL_LIST_INIT(sap_suffixes_male, world.file2list("strings/names/sap_suffix_male.txt"))
GLOBAL_LIST_INIT(sap_suffixes_female, world.file2list("strings/names/sap_suffix_female.txt"))
GLOBAL_LIST_INIT(sap_titles, world.file2list("strings/names/sap_title.txt"))
