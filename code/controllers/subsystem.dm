...
/datum/controller/subsystem
	...
	var/display_order = 0 // Used to display subsystems in a custom order, defaults to alphabetic if no subsystems have a display order set/have equal display order
